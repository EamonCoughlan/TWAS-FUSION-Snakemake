...
def get_files(wildcards):
    ...
    return expand('models/{{condition}}/{transcriptID}.wgt.RDat', condition = CONDITIONS, transcriptID = glob_wildcards(os.path.join('models/{{condition}}/', '{transcriptID}.wgt.RDat')).transcriptID)
